...
def build_analyze_messages(
    ...
    *,
    ...
    system = (
        ...
        "Все текстовые поля JSON — сухие и чистые: без мусорных символов, "
        "markdown/HTML, emoji, управляющих символов и лишней информации, "
        "не относящейся к сути письма.\n\n"
        ...
        "   • письма на помощника зам. операционного директора / "
        "заместителю операционного директора → 00-000182 "
        "(Управление делами может переводить);\n"
