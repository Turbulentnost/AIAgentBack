...
from agent_pochta.metrics.prometheus_exporter import rolling_24h_window_utc
...
def email_messages_stats(
    ...
    with get_session_factory()() as session:
        ...
        operator_approvals_last_24h = collect_operator_approvals(
            session,
            start_utc=start_24h,
            end_utc=end_24h,
        )
        return {
            ...
            "operator_approvals_last_24h": operator_approvals_last_24h,
        }
