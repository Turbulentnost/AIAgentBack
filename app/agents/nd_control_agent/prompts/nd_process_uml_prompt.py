...
### Синтаксис Mermaid
- Узлы действий: `A[Название шага]`
- Узлы решений: `B{Условие}`
- Старт/финиш: `Start([Старт])`, `End([Конец])`
- Subgraph: `subgraph role_name["Название роли"]` ... `end`
- Идентификаторы узлов — латиница без пробелов (A, B1, step_1).
"""
