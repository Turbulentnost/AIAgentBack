"""LLM prompts for finance_director_agent — bodies live in system.md / user.md."""
...
from app.agents.finance_director_agent.decisions import FinanceAssessment
...
def extract_untrusted_memo(request: FinanceDirectorAgentRequest) -> str:
    parts: list[str] = []
...
def build_task_hint(
    ...
    return (
        f"Finance exception {assessment.esc_code}: amount={assessment.amount}, "
        f"S10 remaining={assessment.remaining}, s10_ok={assessment.s10_ok}."
    )
