...
REQUIRED_INPUT = ("correlation_id", "tenant_id", "task_type", "position_id")
TASK_TYPES = (
    "analog_review", "substitution_review",
    "kd_deviation_review", "spec_clarification",
)
...
def validate_input(state: dict[str, Any]) -> dict[str, Any]:
    ...
    audit_event(
        ...
        AGENT_ID,
        "validate_input",
        regulation="ТЗ-ПЛАТФ-001 п. 4.1/10; СТО-28-020 шаг 2.5",
