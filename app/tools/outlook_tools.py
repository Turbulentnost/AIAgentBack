...
class UpdateMeetingAttendeesTool(Tool):
    ...
    description = (
        ...
        "и рассылает персональные уведомления: при изменении состава — руководителю и инициатору, "
    ...
    agent_description = (
        ...
        "При изменении состава — письмо руководителю и инициатору; новым — календарное приглашение; "
