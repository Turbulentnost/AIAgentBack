...
class UpdateMeetingAttendeesTool(Tool):
    ...
    description = (
        ...
        "и рассылает персональные уведомления: при удалении — руководителю и инициатору "
        "об изменении состава, новым — календарное приглашение, удалённым — уведомление об исключении."
    )
    agent_description = (
        ...
        "Существующим при добавлении — письмо об обновлении состава; при удалении — "
        "руководителю и инициатору; новым — календарное приглашение; "
