...
def test_build_slot_participant_details_cached_all_free_skips_ews() -> None:
    config = _config()
    ...
    def _unexpected_calendar(*_args, **_kwargs):
...
def test_build_slot_participant_details_cached_busy_reads_company_calendar_for_slot_only() -> None:
    ...
    def _unexpected_freebusy(*_args, **_kwargs):
    ...
    assert freebusy_called is False
