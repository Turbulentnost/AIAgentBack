...
class Settings(BaseSettings):
    ...
    # Procurement manager: Qwen extracts price/city from fetched product pages.
    PROCUREMENT_WEB_USE_QWEN: bool = True
    PROCUREMENT_WEB_QWEN_REFINE_QUERY: bool = False
    PROCUREMENT_WEB_QWEN_TIMEOUT_SECONDS: float = 25.0
    PROCUREMENT_WEB_QWEN_MODEL: str = ""
    ...
    PROCUREMENT_ORCHESTRATOR_REORDER_LOCK_TTL_SECONDS: int = 280
    PROCUREMENT_SUPPLIER_RECONCILIATION_ENABLED: bool = True
    PROCUREMENT_SUPPLIER_RECONCILIATION_INTERVAL_SECONDS: int = 1800
    PROCUREMENT_SUPPLIER_RECONCILIATION_LOCK_TTL_SECONDS: int = 1700
